...
const {
    ...
    mutationFn: (newTodo) => axios.post("http://localhost:3002/todos", newTodo),
    onSuccess: () => {
        // 方法1: 使快取失效並觸發重新獲取
...
<template>
    <div class="overflow-hidden mb-8 bg-white rounded-lg shadow-md">
        ...
        <div class="p-4">
            ...
            <div v-if="isAddSuccess" class="flex items-center p-3 mt-4 text-green-600 bg-green-50 rounded-md">
